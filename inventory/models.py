...
class CustomUser(AbstractUser):
    USER_TYPE_CHOICES = [
        ...
        ('shop_admin', 'แอดมินร้านค้า'),  # ✅ เพิ่ม "แอดมินของร้าน"
        ('customer', 'ลูกค้า'),
    ]
    ...
    is_admin = models.BooleanField(default=False, verbose_name='แอดมินระบบ')
    is_shop_admin = models.BooleanField(default=False, verbose_name='แอดมินร้านค้า')  # ✅ เพิ่มตัวบูลีนนี้
...
class Product(models.Model):
    ...
    UNIT_CHOICES = [
        ('kg', 'กิโลกรัม'),  # สำหรับสินค้าที่ชั่งน้ำหนัก เช่น ผัก, เนื้อสัตว์
        ('g', 'กรัม'),  # สำหรับสินค้าปริมาณน้อย เช่น เครื่องเทศ
        ('pcs', 'ชิ้น'),  # สำหรับสินค้าที่ขายเป็นชิ้น เช่น โทรศัพท์, รองเท้า
        ('box', 'กล่อง'),  # สำหรับสินค้าที่บรรจุกล่อง เช่น กระดาษ, ขนม
        ('pack', 'แพ็ค'),  # สำหรับสินค้าหลายชิ้นรวมกัน เช่น น้ำดื่ม, ทิชชู่
        ('bottle', 'ขวด'),  # สำหรับของเหลวที่บรรจุขวด เช่น น้ำ, น้ำมันพืช
        ('bag', 'ถุง'),  # สำหรับของที่ขายเป็นถุง เช่น ข้าวสาร, น้ำตาล
        ('roll', 'ม้วน'),  # สำหรับสินค้าที่ยาวและม้วนได้ เช่น เทปกาว, ผ้า
        ('sheet', 'แผ่น'),  # สำหรับวัสดุเช่น กระดาษ, ไม้อัด
        ('meter', 'เมตร'),  # สำหรับของที่ขายตามความยาว เช่น สายไฟ, ผ้า
        ('liter', 'ลิตร'),  # สำหรับของเหลวที่วัดเป็นลิตร เช่น นม, น้ำมัน
        ('Crate', 'ลัง'),
        ('sachet', 'ซอง'),
    ]
